      ...
      array("name" => "Swedish Constraint Network Workshop",
	    "data" => array(
            array("year"  => 2014,
                  ...
                  "role"  => "organizer",
		  "place" => "Kista, Sweden",
		  "url"   => "http://www.gecode.rog/~schulte/events/SweConsNet-2014/"),
            array("year"  => 2012,
                  "month" => "MAY",
                  "role"  => "organizer",
		  "place" => "Örebro, Sweden",
		  "url"   => "http://www.gecode.rog/~schulte/events/SweConsNet-2012/"),
            array("year"  => 2006,
                  "month" => "MAR",
                  "role"  => "organizer",
		  "place" => "Kista, Sweden",
		  "url"   => "http://www.gecode.rog/~schulte/events/SweConsNet/"))),
